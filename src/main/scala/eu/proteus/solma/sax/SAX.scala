 ...
 *
 * This class contains the implementation to extract words from a signal given a number of
 * elements to be averaged using PAA, a size of the alphabet, and the length of the words
 * to be generated.
 *
 * References:
