...
@Proteus
class COIRR extends StreamTransformer[COIRR]{

  import eu.proteus.solma.coirr.COIRR._

  /** Get the WorkerParallism value as Int
    * @return The number of worker parallelism
    */
  def getWorkerParallelism() : Int  = {
    this.parameters.get(COIRR.WorkerParallism).get
  }
  ...
  /**
    ...
    * @return
    */
  def setWorkerParallelism(workerParallism : Int): COIRR = {
  ...
  /**
    ...
    * @return
    */
  def setPSParallelism(psParallelism : Int): COIRR = {
  ...
  /**
    ...
    * @return
    */
  def setIterationWaitTime(iterationWaitTime: Long) : COIRR = {
  ...
  /**
    ...
    * @param pullLimit
    */
  def setPullLimit(pullLimit : Int) : COIRR = {
  ...
  /**
    ...
    */
  def setAllowedLateness(allowedLateness: Int) : COIRR = {
  ...
  /**
    ...
    * @param featuresCount
    */
  def setFeaturesCount(featuresCount: Int) : COIRR = {
...
object COIRR extends WithParameters with Serializable {

  type COIRRStreamEvent = Either[(Long, StreamEvent), Label]
  type COIRRModel = (DenseMatrix[Double], DenseVector[Double], DenseVector[Double], Double)
