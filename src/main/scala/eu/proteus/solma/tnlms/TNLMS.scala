...
@Proteus
class TNLMS extends StreamTransformer[TNLMS]{

  import eu.proteus.solma.tnlms.TNLMS._

  /** Get the WorkerParallism value as Int
    * @return The number of worker parallelism
    */
  def getWorkerParallelism() : Int  = {
    this.parameters.get(TNLMS.WorkerParallism).get
  }
  ...
  /**
    ...
    * @return
    */
  def setWorkerParallelism(workerParallism : Int): TNLMS = {
  ...
  /**
    ...
    * @return
    */
  def setPSParallelism(psParallelism : Int): TNLMS = {
  ...
  /**
    ...
    * @return
    */
  def setIterationWaitTime(iterationWaitTime: Long) : TNLMS = {
  ...
  /**
    ...
    * @param pullLimit
    */
  def setPullLimit(pullLimit : Int) : TNLMS = {
  ...
  /**
    ...
    */
  def setAllowedLateness(allowedLateness: Int) : TNLMS = {
  ...
  /**
    ...
    * @param featuresCount
    */
  def setFeaturesCount(featuresCount: Int) : TNLMS = {
...
object TNLMS extends WithParameters with Serializable {

  type TNLMSStreamEvent = Either[(Long, StreamEvent), Label]
  type TNLMSModel = (DenseVector[Double], Double)
