...
@Proteus
class CCIPCA extends StreamTransformer[CCIPCA]{

  import eu.proteus.solma.ccipca.CCIPCA._

  /** Get the WorkerParallism value as Int
    * @return The number of worker parallelism
    */
  def getWorkerParallelism() : Int  = {
    this.parameters.get(CCIPCA.WorkerParallism).get
  }
  ...
  /**
    ...
    * @return
    */
  def setWorkerParallelism(workerParallism : Int): CCIPCA = {
  ...
  /**
    ...
    * @return
    */
  def setPSParallelism(psParallelism : Int): CCIPCA = {
  ...
  /**
    ...
    * @return
    */
  def setIterationWaitTime(iterationWaitTime: Long) : CCIPCA = {
  ...
  /**
    ...
    * @param pullLimit
    */
  def setPullLimit(pullLimit : Int) : CCIPCA = {
  ...
  /**
    ...
    */
  def setAllowedLateness(allowedLateness: Int) : CCIPCA = {
  ...
  /**
    ...
    * @param featuresCount
    */
  def setFeaturesCount(featuresCount: Int) : CCIPCA = {
...
object CCIPCA extends WithParameters with Serializable {

  // type CCIPCAStreamEvent = StreamEvent
  type CCIPCAModel = DenseMatrix[Double]
