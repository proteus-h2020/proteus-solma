...
@Proteus
class OSLOG extends StreamTransformer[OSLOG]{

  import eu.proteus.solma.oslog.OSLOG._

  /** Get the WorkerParallism value as Int
    * @return The number of worker parallelism
    */
  def getWorkerParallelism() : Int  = {
    this.parameters.get(OSLOG.WorkerParallism).get
  }
  ...
  /**
    ...
    * @return
    */
  def setWorkerParallelism(workerParallism : Int): OSLOG = {
  ...
  /**
    ...
    * @return
    */
  def setPSParallelism(psParallelism : Int): OSLOG = {
  ...
  /**
    ...
    * @return
    */
  def setIterationWaitTime(iterationWaitTime: Long) : OSLOG = {
  ...
  /**
    ...
    * @param pullLimit
    */
  def setPullLimit(pullLimit : Int) : OSLOG = {
  ...
  /**
    ...
    */
  def setAllowedLateness(allowedLateness: Int) : OSLOG = {
  ...
  /**
    ...
    * @param featuresCount
    */
  def setFeaturesCount(featuresCount: Int) : OSLOG = {
