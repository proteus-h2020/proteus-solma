...
case class weightedMeanAndVariance(
                                    ...
                                    featurecount:Int) {
  private val meaa=samples.fold(WeightedSample(IndexedSeq(),DenseVector.zeros(featurecount),DenseVector.zeros(featurecount)))(
  ...
  private val varaa=samples.fold(WeightedSample(IndexedSeq(),DenseVector.zeros(featurecount),DenseVector.zeros(featurecount)))(
                                (i,j)=> {val temp=i.data.asBreeze.copy
